...
public class ProviderDTO2 {
    ...
    public ProviderDTO2(String id, String name, String nameContact, String emailContact, PersonType personType, String cpfOrCnpj, String activityDescription, Address address, List<Phone> phoneList) {
        this.id = id;
        this.name = name;
    ...
    public ProviderDTO2 convertProviderToDTO (Provider provider){
